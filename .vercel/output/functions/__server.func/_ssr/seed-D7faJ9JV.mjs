...
import { n as uid } from "./utils-DkRSI2_g.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/seed-D7faJ9JV.js
/**
...
var authMiddleware = createMiddleware({ type: "function" }).client(async ({ next }) => {
	const { getBearerToken } = await import("./client-C9atugA7.mjs").then((n) => n.n);
	return next({ sendContext: { bearerToken: getBearerToken() ?? void 0 } });
}).server(async ({ next, context }) => {
	const { assertSameSiteRequest } = await import("./isolation.server-CGNg1r0B.mjs");
	const { requireUserId } = await import("./verify.server-2LHiOIs-.mjs");
...
function seedWorkspace() {
	const gettingStarted = createEmptyPage({
		...
		blocks: blocks({
			type: "paragraph",
			content: "Welcome to your workspace — notes, AI assist, Mermaid diagrams, and optional database sync."
		}, {
			type: "heading1",
...
//#endregion
export { seedWorkspace as a, createEmptyPage as i, PAGE_ICONS as n, authMiddleware as r, COVER_PRESETS as t };
