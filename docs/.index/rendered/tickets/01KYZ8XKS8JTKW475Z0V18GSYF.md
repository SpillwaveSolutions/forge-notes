...
`01KYZ8XKS8JTKW475Z0V18GSYF` · story/ops · **open**

Install vitest+jsdom and @playwright/test pinned to 1.61.1 (matching the installed chromium rev 1228 that scripts/browser-smoke.mjs depends on).
