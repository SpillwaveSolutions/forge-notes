...
`01KYZ8XM2SCZG43J0MD59P4ZHK` · story/feature · **open**

Add structural data attributes (data-block-type, data-wizard-step) rather than enumerated testids, aria-labels for the ~20 unnamed icon-only buttons, role/aria-modal on CommandPalette, id/htmlFor on form controls.
