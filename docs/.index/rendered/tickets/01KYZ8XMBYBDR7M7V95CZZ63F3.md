...
`01KYZ8XMBYBDR7M7V95CZZ63F3` · story/feature · **done**

One markdown per screen family under docs/ui (invisible to the worklog IA, so zero coupling), PlantUML Salt wireframes rendered by two package.json lines.
